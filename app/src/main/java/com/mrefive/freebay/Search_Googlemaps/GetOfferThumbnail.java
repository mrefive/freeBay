 ...
 */
public class GetOfferThumbnail extends AsyncTask<String, Void, String> {

    private String serverimagename;

    @Override
    protected String doInBackground(String... params) {
        String post_url= "https://sommer.kdt-hosting.ch/freebay/getofferthumbnail.php";
        ...
        try {
            ...
            String data =
                    URLEncoder.encode("UUID", "UTF-8") +"="+ URLEncoder.encode(UOID, "UTF-8")+
    ...
    protected void onPostExecute(String s) {
        ...
        if(!s.equals("Error finding image")) {
            ...
            serverimagename = "thumb_"+serverimagename;
            try {
